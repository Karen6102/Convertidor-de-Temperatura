...
// ==========================================
// REGISTRO UNIVERSAL PARA GITHUB PAGES Y PC
// ==========================================
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    // Eliminamos el parámetro 'scope' para que el navegador lo maneje en automático
    navigator.serviceWorker.register('./JS/sw.js')
      .then(registration => {
        console.log('¡PWA Activa en GitHub! SW registrado en:', registration.scope);
      })
      .catch(error => {
